...
$(function() {
    $(putEmoAbove)
    .before('<div style="text-align:center" class="emoWrap"><b>List Emoticon : (Gunakan Sepuasnya broo!!!)</b><br/> :argh: :tolong: :bening: :haha: :hehe: :kaget: :hah: :lagu: :lol: :lalala: :nangis: :onegai: :daisuki: :terharu: :mantap: :yahoo: :yare2: :troll: :udonsay: :wanipiro: :udud: :ecchi: :hoho: :pakyu: :lolol: :gebuk: :pong: :keplak: :usap: :mlayu: :muter: :asoy: :jotos: <br/><b>Klik gambar emot untuk melihat code!</b><br/>Jangan Lupa pencet spasi dahulu sebelum nulis code emotnya.</div>');
