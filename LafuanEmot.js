var emoRange = "#comments p, div.emoWrap",
    ...
    emoMessage = "Jangan Lupa pencet spasi dahulu sebelum nulis code emotnya.";

// Emoticon bar before comment-form
$(function() {
    $(putEmoAbove)
        .before('<div style="text-align:center" class="emoWrap"> :argh: :tolong: :bening: :haha: :hehe: :kaget: :hah: :lagu: :lol: :lalala: :nangis: :onegai: :daisuki: :terharu: :mantap: :yahoo: :yare2: :troll: :udonsay: :wanipiro: :ecchi: :hoho: :pakyu: :lolol: :gebuk: :pong: :keplak: :keplak2: :mlayu: :muter: :asoy: :sodok: :sodok3: :usap: :maso: :jotos: :pare: :udud: :huha: :bean: :yaoming: :yaosay: :lapar: :anjrit: :harasho: <br/><b>Klik gambar emot untuk melihat code!</b><br/>Jangan Lupa pencet spasi dahulu sebelum nulis code emotnya.</div>');
    var emo = function(emo, imgRep, emoKey) {
        $(emoRange)
            ...
            $(this)
                ...
                .replace(/<br>=/g, "<br> =")
                .replace(/<br>\^/g, "<br> ^")
                .replace(emo, " <img style='max-height:100px' src='" + imgRep + "' class='emo delayLoad' alt='" + emoKey + "' />"));
        });
    };
...
emo(/\s:yaosay:/ig, "https://3.bp.blogspot.com/-Vyn1PTmL-oQ/WB_CIbPzM4I/AAAAAAAABXg/EvIhEoB7ezoItIc-g7DuVJVJ05iJVLcowCLcB/s1600/yaosay.jpg", ":yaosay:");
emo(/\s:huha:/ig, "https://2.bp.blogspot.com/-_aealhbOT6M/WB_B-itU51I/AAAAAAAABVc/VgoR4RwKzDUyXCe2gShospd-Au92oltjgCLcB/s1600/huha.jpg", ":huha:");
emo(/\s:harasho:/ig, "https://2.bp.blogspot.com/-cmS32x7dckQ/WB_B9749gJI/AAAAAAAABVU/mC0V11RjURIGYvcU-xoZGCR00V8Fl9rqwCLcB/s1600/harasho.jpg", ":harasho:");
emo(/\s:lapar:/ig, "https://3.bp.blogspot.com/-NBpbn-HKk_8/WB_CA2fKAUI/AAAAAAAABV8/KKJEORIxPGwv44OTAyQNTH7zD9-z-rWiwCLcB/s1600/lapar.jpg", ":lapar:");
emo(/\s:anjrit:/ig, "https://4.bp.blogspot.com/-XbksVua2RY0/WB_B6y6y7YI/AAAAAAAABUs/iTAe4lD9LdU0lvJPs1VbEQXbv1HIk6fPACLcB/s1600/anjrit.jpg", ":anjrit:");
